 ...
 * C source code generated on : Wed Oct 17 17:53:08 2018
 *
...
void P2p1_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    P2p1_B.ElevationCounttorad = P2p1_P.ElevationCounttorad_Gain * rtb_Sum_k;

    /* Gain: '<S11>/Gain' */
    P2p1_B.Gain = P2p1_P.Gain_Gain * P2p1_B.ElevationCounttorad;
     ...
     *  Sum: '<Root>/Sum1'
     */
    rtb_Sum_k = P2p1_P.Referenceelevation_Value - ((P2p1_B.Gain -
      P2p1_P.ElevationConstant_Value) * P2p1_P.Gain1_Gain - P2p1_P.e_star);

    /* Gain: '<S10>/K_ep' */
    P2p1_B.K_ep = P2p1_P.K_ep_Gain * rtb_Sum_k;

    /* Constant: '<Root>/e_dot_star' */
    P2p1_B.e_dot_star = P2p1_P.e_dot_star;
  }
   ...
   *  Sum: '<Root>/Sum2'
   */
  P2p1_B.Sum = (rtb_Frontgain + P2p1_B.K_ep) - (P2p1_P.Gain1_Gain_f *
    P2p1_B.Gain_d - P2p1_B.e_dot_star) * P2p1_P.K_ed_Gain;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    if (P2p1_B.RateTransitionx > P2p1_P.DeadZonex_End) {
      rtb_Backgain = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_End;
    } else if (P2p1_B.RateTransitionx >= P2p1_P.DeadZonex_Start) {
      rtb_Backgain = 0.0;
    } else {
      rtb_Backgain = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S8>/Gain: x'
     */
    P2p1_B.Joystick_gain_x = P2p1_P.Gainx_Gain * rtb_Backgain *
    ...
    /* Gain: '<S9>/K_pp' incorporates:
     *  Constant: '<Root>/p_star1'
     *  Gain: '<S2>/Gain1'
     *  Sum: '<Root>/Sum3'
     *  Sum: '<S9>/Sum'
     */
    P2p1_B.K_pp = (P2p1_B.Joystick_gain_x - (P2p1_P.Gain1_Gain_b * P2p1_B.Gain_i
      - P2p1_P.p_star)) * P2p1_P.K_pp;

    /* Constant: '<Root>/p_dot_star' */
    P2p1_B.p_dot_star = P2p1_P.p_dot_star;
  }
   ...
   *  Sum: '<Root>/Sum4'
   */
  rtb_Backgain = P2p1_B.K_pp - (P2p1_P.Gain1_Gain_p * P2p1_B.Gain_b -
    P2p1_B.p_dot_star) * P2p1_P.K_pd;

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  rtb_Frontgain = (rtb_Backgain + P2p1_B.Sum) * P2p1_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Gain: '<S10>/K_ei' */
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Backgain = (P2p1_B.Sum - rtb_Backgain) * P2p1_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    if (P2p1_B.RateTransitiony > P2p1_P.DeadZoney_End) {
      rtb_Backgain = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_End;
    } else if (P2p1_B.RateTransitiony >= P2p1_P.DeadZoney_Start) {
      rtb_Backgain = 0.0;
    } else {
      rtb_Backgain = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S8>/Gain: y'
     */
    P2p1_B.Joystick_gain_y = P2p1_P.Gainy_Gain * rtb_Backgain *
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (3915969677U);
  P2p1_M->Sizes.checksums[1] = (2183086779U);
  P2p1_M->Sizes.checksums[2] = (196120509U);
  P2p1_M->Sizes.checksums[3] = (3086086939U);
  ...
  P2p1_M->Sizes.numBlocks = (64);      /* Number of blocks */
