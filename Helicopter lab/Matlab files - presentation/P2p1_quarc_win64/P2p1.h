...
typedef struct {
  ...
  real_T K_pp;                         /* '<S9>/K_pp' */
  real_T p_dot_star;                   /* '<Root>/p_dot_star' */
...
struct P_P2p1_T_ {
  ...
  real_T Gain_Gain;                    /* Expression: 180/pi
                                        ...
                                        */
  real_T ElevationConstant_Value;      /* Expression: 30
                                        * Referenced by: '<Root>/Elevation Constant'
                                        */
 ...
 * '<S3>'   : 'P2p1/Degrees to Radians1'
 * '<S4>'   : 'P2p1/Degrees to Radians2'
 * '<S5>'   : 'P2p1/Degrees to Radians3'
 * '<S6>'   : 'P2p1/Elevation controller'
 * '<S7>'   : 'P2p1/Heli 3D'
 * '<S8>'   : 'P2p1/Joystick'
 * '<S9>'   : 'P2p1/Pitch controller'
 * '<S10>'  : 'P2p1/Elevation controller/Elevation controller'
 * '<S11>'  : 'P2p1/Heli 3D/Elevation rad to deg'
 * '<S12>'  : 'P2p1/Heli 3D/Elevation rate rad to deg'
 * '<S13>'  : 'P2p1/Heli 3D/Pitch rad to deg'
 * '<S14>'  : 'P2p1/Heli 3D/Pitch rate rad to deg'
 * '<S15>'  : 'P2p1/Heli 3D/Travel rad to deg'
 * '<S16>'  : 'P2p1/Heli 3D/Travel rate  rad to deg'
 */
