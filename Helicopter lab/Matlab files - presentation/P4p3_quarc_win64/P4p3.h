...
/* State disabled  */
typedef struct {
  boolean_T _CSTATE;                   /* '<Root>/ ' */
  boolean_T _CSTATE_n;                 /* '<Root>/  ' */
