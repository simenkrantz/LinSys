 ...
 * C source code generated on : Wed Oct 17 18:45:58 2018
 *
...
void P4p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
     ...
     */
    P4p3_B.Sum = P4p3_B.Gain_e - P4p3_P.ElevationConstant_Value;
  }
  ...
  tmp[3] = P4p3_B.Gain_d;
  tmp[4] = P4p3_B.Gain_p;
  tmp[5] = P4p3_B.Gain_dc;
  for (i = 0; i < 6; i++) {
    tmp_0[i] = P4p3_P.Gain1_Gain * tmp[i];
  }
  ...
  for (i = 0; i < 2; i++) {
    rtb_Sum1[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Sum1[i] += P4p3_P.C[(i_0 << 1) + i] * tmp_0[i_0];
    }
  }

  if (rtmIsMajorTimeStep(P4p3_M)) {
    /* Constant: '<Root>/Constant1' */
    P4p3_B.Constant1 = P4p3_P.Constant1_Value;
     ...
     */
    P4p3_B.P[0] = 0.0;
    P4p3_B.P[0] += P4p3_P.P[0] * P4p3_B.Joystick_gain_x;
    P4p3_B.P[0] += P4p3_P.P[2] * P4p3_B.Joystick_gain_y;
    P4p3_B.P[1] = 0.0;
    P4p3_B.P[1] += P4p3_P.P[1] * P4p3_B.Joystick_gain_x;
    P4p3_B.P[1] += P4p3_P.P[3] * P4p3_B.Joystick_gain_y;
  }
   ...
   */
  tmp_1[0] = P4p3_X.Integrator2_CSTATE[0];
  tmp_1[1] = P4p3_X.Integrator2_CSTATE[1];
  tmp_1[2] = P4p3_X.Integrator2_CSTATE[3];
  tmp_1[3] = P4p3_X._CSTATE;
  tmp_1[4] = P4p3_X._CSTATE_n;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Backgain = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Backgain += P4p3_P.K[(i_0 << 1) + i] * tmp_1[i_0];
    }

    rtb_C[i] = P4p3_B.P[i] - rtb_Backgain;
  }

  /* End of Sum: '<Root>/Sum5' */

  /* Sum: '<Root>/Sum6' */
  rtb_Backgain = rtb_C[0] + P4p3_B.Constant1;
  if (rtmIsMajorTimeStep(P4p3_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_C[1] + rtb_Backgain) * P4p3_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain - rtb_C[1]) * P4p3_P.Backgain_Gain;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Backgain = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Backgain += P4p3_P.C[(i_0 << 1) + i] * P4p3_X.Integrator2_CSTATE[i_0];
    }
  ...
  for (i = 0; i < 6; i++) {
    ...
    tmp[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp[i] += P4p3_P.A[6 * i_0 + i] * P4p3_X.Integrator2_CSTATE[i_0];
    }
     ...
     */
    tmp_0[i] = 0.0;
    tmp_0[i] += P4p3_P.B[i] * rtb_C[0];
    tmp_0[i] += P4p3_P.B[i + 6] * rtb_C[1];

    /* Sum: '<S5>/Sum9' incorporates:
     *  Gain: '<S5>/L'
     */
    P4p3_B.Sum9[i] = (P4p3_P.L[i + 6] * rtb_Sum1[1] + P4p3_P.L[i] * rtb_Sum1[0])
      + (tmp[i] + tmp_0[i]);
  }
   ...
   *  Integrator: '<S5>/Integrator2'
   */
  P4p3_B.Sum1 = P4p3_X.Integrator2_CSTATE[0] - P4p3_B.Joystick_gain_x;

  /* Sum: '<Root>/Sum2' incorporates:
   *  Integrator: '<S5>/Integrator2'
   */
  P4p3_B.Sum2 = P4p3_X.Integrator2_CSTATE[3] - P4p3_B.Joystick_gain_y;
}
...
void P4p3_derivatives(void)
{
  ...
  _rtXdot->_CSTATE = P4p3_B.Sum1;

  /* Derivatives for Integrator: '<Root>/  ' */
  _rtXdot->_CSTATE_n = P4p3_B.Sum2;
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator2_CSTATE[i] = P4p3_B.Sum9[i];
  }
...
void P4p3_initialize(void)
{
...

  {
    ...
    P4p3_X._CSTATE = P4p3_P._IC;

    /* InitializeConditions for Integrator: '<Root>/  ' */
    P4p3_X._CSTATE_n = P4p3_P._IC_p;
...
RT_MODEL_P4p3_T *P4p3(void)
{
  ...
  /* External mode info */
  P4p3_M->Sizes.checksums[0] = (405432909U);
  P4p3_M->Sizes.checksums[1] = (2529390845U);
  P4p3_M->Sizes.checksums[2] = (4183545302U);
  P4p3_M->Sizes.checksums[3] = (1863114090U);
  ...
  P4p3_M->Sizes.numBlockPrms = (233);  /* Sum of parameter "widths" */
  return P4p3_M;
}
