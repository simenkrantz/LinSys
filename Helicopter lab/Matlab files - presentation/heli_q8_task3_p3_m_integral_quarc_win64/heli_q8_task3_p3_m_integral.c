...
void heli_q8_task3_p3_m_integral_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* Step: '<Root>/Step' */
  if (heli_q8_task3_p3_m_integral_M->Timing.t[0] <
      heli_q8_task3_p3_m_integral_P.Step_Time) {
    rtb_Step = heli_q8_task3_p3_m_integral_P.Step_Y0;
  } else {
    rtb_Step = heli_q8_task3_p3_m_integral_P.Step_YFinal;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_task3_p3_m_integral_M)) {
    ...
    heli_q8_task3_p3_m_integral_B.PitchCounttorad =
      heli_q8_task3_p3_m_integral_P.PitchCounttorad_Gain * rtb_DeadZoney;
    ...
    heli_q8_task3_p3_m_integral_B.TmpSignalConversionAtToWorkspac[0] =
      heli_q8_task3_p3_m_integral_B.Gain;
    heli_q8_task3_p3_m_integral_B.TmpSignalConversionAtToWorkspac[1] =
      heli_q8_task3_p3_m_integral_B.Gain_i;
  ...
  if (rtmIsMajorTimeStep(heli_q8_task3_p3_m_integral_M)) {
    ...
    heli_q8_task3_p3_m_integral_B.ElevationCounttorad =
      heli_q8_task3_p3_m_integral_P.ElevationCounttorad_Gain * rtb_DeadZonex;
  }
   ...
   *  Gain: '<S4>/Gain1'
   */
  rtb_Sum2 = heli_q8_task3_p3_m_integral_P.Gain1_Gain_o *
    heli_q8_task3_p3_m_integral_B.Gain_d -
    heli_q8_task3_p3_m_integral_B.e_dot_star;
  ...
  tmp[1] = heli_q8_task3_p3_m_integral_P.Gain1_Gain_p *
    heli_q8_task3_p3_m_integral_B.Gain_b -
    heli_q8_task3_p3_m_integral_B.p_dot_star1;
  tmp[2] = rtb_Sum2;
  ...
  for (i = 0; i < 2; i++) {
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_0[i] += heli_q8_task3_p3_m_integral_P.K[(i_0 << 1) + i] * tmp[i_0];
    }
  }
   ...
   */
  rtb_Sum5_idx_1 = (heli_q8_task3_p3_m_integral_P.P[1] * rtb_Step +
                    heli_q8_task3_p3_m_integral_P.P[3] *
                    heli_q8_task3_p3_m_integral_B.Joystick_gain_y) - tmp_0[1];
   ...
   *  Sum: '<Root>/Sum5'
   */
  rtb_Backgain = ((heli_q8_task3_p3_m_integral_P.P[0] * rtb_Step +
                   heli_q8_task3_p3_m_integral_P.P[2] *
                   heli_q8_task3_p3_m_integral_B.Joystick_gain_y) - tmp_0[0]) +
    heli_q8_task3_p3_m_integral_B.Constant1;
  if (rtmIsMajorTimeStep(heli_q8_task3_p3_m_integral_M)) {
    /* Gain: '<S8>/Gain' */
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Sum5_idx_1 + rtb_Backgain) *
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain - rtb_Sum5_idx_1) *
  ...
  if (rtmIsMajorTimeStep(heli_q8_task3_p3_m_integral_M)) {
    ...
    if (heli_q8_task3_p3_m_integral_B.RateTransitionx >
      ...
      rtb_DeadZonex = heli_q8_task3_p3_m_integral_B.RateTransitionx -
        heli_q8_task3_p3_m_integral_P.DeadZonex_End;
    ...
    heli_q8_task3_p3_m_integral_B.Joystick_gain_x =
      heli_q8_task3_p3_m_integral_P.Gainx_Gain * rtb_DeadZonex *
...
RT_MODEL_heli_q8_task3_p3_m_i_T *heli_q8_task3_p3_m_integral(void)
{
  ...
  /* External mode info */
  heli_q8_task3_p3_m_integral_M->Sizes.checksums[0] = (3807688320U);
  heli_q8_task3_p3_m_integral_M->Sizes.checksums[1] = (3725698732U);
  heli_q8_task3_p3_m_integral_M->Sizes.checksums[2] = (1785635571U);
  heli_q8_task3_p3_m_integral_M->Sizes.checksums[3] = (3415235438U);
...

  {
    ...
    heli_q8_task3_p3_m_integral_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    heli_q8_task3_p3_m_integral_B.TmpSignalConversionAtToWorkspac[1] = 0.0;
    ...
    heli_q8_task3_p3_m_integral_B.Gain_p = 0.0;
  ...
  /* Initialize Sizes */
  heli_q8_task3_p3_m_integral_M->Sizes.numContStates = (5);/* Number of continuous states */
  ...
  heli_q8_task3_p3_m_integral_M->Sizes.numBlocks = (62);/* Number of blocks */
  heli_q8_task3_p3_m_integral_M->Sizes.numBlockIO = (25);/* Number of block outputs */
  heli_q8_task3_p3_m_integral_M->Sizes.numBlockPrms = (168);/* Sum of parameter "widths" */
