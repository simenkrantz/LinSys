 ...
 * '<S3>'   : 'P2p2/Degrees to Radians1'
 * '<S4>'   : 'P2p2/Degrees to Radians2'
 * '<S5>'   : 'P2p2/Degrees to Radians3'
 * '<S6>'   : 'P2p2/Degrees to Radians4'
 * '<S7>'   : 'P2p2/Elevation controller'
 * '<S8>'   : 'P2p2/Heli 3D'
 * '<S9>'   : 'P2p2/Joystick'
 * '<S10>'  : 'P2p2/Pitch controller'
 * '<S11>'  : 'P2p2/Travel controller'
