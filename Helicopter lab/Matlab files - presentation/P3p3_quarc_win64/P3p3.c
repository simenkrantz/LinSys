 ...
 * C source code generated on : Wed Oct 17 18:13:20 2018
 *
...
void P3p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    P3p3_B.Constant1 = P3p3_P.Constant1_Value;
     ...
     */
    P3p3_B.P[0] = 0.0;
    P3p3_B.P[0] += P3p3_P.P[0] * P3p3_B.Joystick_gain_x;
    P3p3_B.P[0] += P3p3_P.P[2] * P3p3_B.Joystick_gain_y;
    P3p3_B.P[1] = 0.0;
    P3p3_B.P[1] += P3p3_P.P[1] * P3p3_B.Joystick_gain_x;
    P3p3_B.P[1] += P3p3_P.P[3] * P3p3_B.Joystick_gain_y;

    /* Sum: '<Root>/Sum3' incorporates:
     *  Constant: '<Root>/p_star1'
     *  Gain: '<S3>/Gain1'
     */
    P3p3_B.Sum3 = P3p3_P.Gain1_Gain * P3p3_B.Gain - P3p3_P.p_star;

    /* Constant: '<Root>/p_dot_star1' */
    P3p3_B.p_dot_star1 = P3p3_P.p_dot_star;
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    P3p3_B.e_dot_star = P3p3_P.e_dot_star;
   ...
   *  Gain: '<S4>/Gain1'
   */
  rtb_Sum2 = P3p3_P.Gain1_Gain_o * P3p3_B.Gain_d - P3p3_B.e_dot_star;
   ...
   */
  tmp[0] = P3p3_B.Sum3;
  tmp[1] = P3p3_P.Gain1_Gain_p * P3p3_B.Gain_b - P3p3_B.p_dot_star1;
  tmp[2] = rtb_Sum2;
  ...
  for (i = 0; i < 2; i++) {
    ...
    rtb_Sum5[i] = P3p3_B.P[i] - rtb_Backgain;
  }

  /* End of Sum: '<Root>/Sum5' */

  /* Sum: '<Root>/Sum6' */
  rtb_Backgain = rtb_Sum5[0] + P3p3_B.Constant1;
  if (rtmIsMajorTimeStep(P3p3_M)) {
    /* Gain: '<S7>/Gain' */
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Sum5[1] + rtb_Backgain) * P3p3_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain - rtb_Sum5[1]) * P3p3_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    /* Sum: '<Root>/Sum7' */
    P3p3_B.Sum7 = P3p3_B.Sum3 - P3p3_B.Joystick_gain_x;
  }

  /* Sum: '<Root>/Sum8' */
  P3p3_B.Sum8 = rtb_Sum2 - P3p3_B.Joystick_gain_y;
}
...
void P3p3_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = P3p3_B.Sum7;

  /* Derivatives for Integrator: '<Root>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = P3p3_B.Sum8;
...
RT_MODEL_P3p3_T *P3p3(void)
{
  ...
  /* External mode info */
  P3p3_M->Sizes.checksums[0] = (3980125542U);
  P3p3_M->Sizes.checksums[1] = (2753531350U);
  P3p3_M->Sizes.checksums[2] = (3516330076U);
  P3p3_M->Sizes.checksums[3] = (1987059772U);
...

  {
    ...
    P3p3_B.P[1] = 0.0;
    P3p3_B.Sum3 = 0.0;
    P3p3_B.p_dot_star1 = 0.0;
    P3p3_B.Gain_b = 0.0;
    P3p3_B.e_dot_star = 0.0;
