...
MODEL                = heli_q8_task2
MODULES              = heli_q8_task2_data.c heli_q8_task2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_task2.mk
...
MODELLIB                  = heli_q8_task2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_task2_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_task2_quarc_win64
