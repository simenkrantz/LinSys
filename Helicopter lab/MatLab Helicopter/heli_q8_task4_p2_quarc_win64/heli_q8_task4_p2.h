 ...
 */
#ifndef RTW_HEADER_heli_q8_task4_p2_h_
#define RTW_HEADER_heli_q8_task4_p2_h_
#include <string.h>
#ifndef heli_q8_task4_p2_COMMON_INCLUDES_
# define heli_q8_task4_p2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_task4_p2_COMMON_INCLUDES_ */

#include "heli_q8_task4_p2_types.h"
...
#define heli_q8_task4_p2_rtModel       RT_MODEL_heli_q8_task4_p2_T

/* Block signals (auto storage) */
typedef struct {
  real_T PitchCounttorad;              /* '<S3>/Pitch: Count to rad' */
  real_T Gain;                         /* '<S11>/Gain' */
  real_T Integrator2[6];               /* '<S6>/Integrator2' */
...
#define rtB                            heli_q8_task4_p2_B
#define BlockIO                        B_heli_q8_task4_p2_T
#define rtX                            heli_q8_task4_p2_X
#define ContinuousStates               X_heli_q8_task4_p2_T
#define rtXdot                         heli_q8_task4_p2_XDot
#define StateDerivatives               XDot_heli_q8_task4_p2_T
#define tXdis                          heli_q8_task4_p2_XDis
#define StateDisabled                  XDis_heli_q8_task4_p2_T
#define rtP                            heli_q8_task4_p2_P
#define Parameters                     P_heli_q8_task4_p2_T
#define rtDWork                        heli_q8_task4_p2_DW
#define D_Work                         DW_heli_q8_task4_p2_T

/* Parameters (auto storage) */
struct P_heli_q8_task4_p2_T_ {
...
struct tag_RTM_heli_q8_task4_p2_T {
  const char_T *path;
...
extern P_heli_q8_task4_p2_T heli_q8_task4_p2_P;

/* Block signals (auto storage) */
extern B_heli_q8_task4_p2_T heli_q8_task4_p2_B;

/* Continuous states (auto storage) */
extern X_heli_q8_task4_p2_T heli_q8_task4_p2_X;

/* Block states (auto storage) */
extern DW_heli_q8_task4_p2_T heli_q8_task4_p2_DW;
...
extern void heli_q8_task4_p2_initialize(void);
extern void heli_q8_task4_p2_output0(void);
extern void heli_q8_task4_p2_update0(void);
extern void heli_q8_task4_p2_output(int_T tid);
extern void heli_q8_task4_p2_update(int_T tid);
extern void heli_q8_task4_p2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_task4_p2_T *const heli_q8_task4_p2_M;
 ...
 *
 * '<Root>' : 'heli_q8_task4_p2'
 * '<S1>'   : 'heli_q8_task4_p2/Conversion'
 * '<S2>'   : 'heli_q8_task4_p2/Elevation controller'
 * '<S3>'   : 'heli_q8_task4_p2/Heli 3D'
 * '<S4>'   : 'heli_q8_task4_p2/Joystick'
 * '<S5>'   : 'heli_q8_task4_p2/Pitch controller'
 * '<S6>'   : 'heli_q8_task4_p2/Subsystem'
 * '<S7>'   : 'heli_q8_task4_p2/Travel controller'
 * '<S8>'   : 'heli_q8_task4_p2/Elevation controller/Elevation controller'
 * '<S9>'   : 'heli_q8_task4_p2/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'heli_q8_task4_p2/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'heli_q8_task4_p2/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'heli_q8_task4_p2/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'heli_q8_task4_p2/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'heli_q8_task4_p2/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_task4_p2_h_ */
