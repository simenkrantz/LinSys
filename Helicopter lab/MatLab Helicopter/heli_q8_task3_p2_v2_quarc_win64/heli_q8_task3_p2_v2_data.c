...
P_heli_q8_task3_p2_v2_T heli_q8_task3_p2_v2_P = {
   ...
   */
  { 0.0, 7.0710678118654782, 0.0, 5.091346131901326, 5.4772255750516612, 0.0 },

  /*  Variable: P
   * Referenced by: '<Root>/P '
   */
  { -0.0, 7.0710678118654791, 5.4772255750516612, 0.0 },
