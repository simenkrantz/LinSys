 ...
 * C source code generated on : Tue Aug 28 10:10:02 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum = heli_q8_B.Gain - heli_q8_P.Constant_Value;
    ...
    /* Gain: '<Root>/Gain' */
    rtb_BackmotorSaturation = heli_q8_P.Gain_Gain_a * heli_q8_B.Joystick_gain_x;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S9>/Gain' */
    heli_q8_B.Gain_i = heli_q8_P.Gain_Gain_ar * heli_q8_B.PitchCounttorad;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S11>/Gain' */
    heli_q8_B.Gain_p = heli_q8_P.Gain_Gain_arf * heli_q8_B.TravelCounttorad;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4061183534U);
  heli_q8_M->Sizes.checksums[1] = (2309772123U);
  heli_q8_M->Sizes.checksums[2] = (2437845519U);
  heli_q8_M->Sizes.checksums[3] = (571653387U);
