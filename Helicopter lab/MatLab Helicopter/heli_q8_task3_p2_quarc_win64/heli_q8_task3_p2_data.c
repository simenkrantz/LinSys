...
P_heli_q8_task3_p2_T heli_q8_task3_p2_P = {
   ...
   */
  { 0.0, 7.0710678118654755, 0.0, 5.9094674408804915, 70.710678118654741, 0.0 },

  /*  Variable: P
   * Referenced by: '<Root>/P '
   */
  { -0.0, 7.0710678118654755, 70.710678118654741, 0.0 },
