 ...
 */
#ifndef RTW_HEADER_heli_q8_task4_p2_v2_h_
#define RTW_HEADER_heli_q8_task4_p2_v2_h_
#include <string.h>
#ifndef heli_q8_task4_p2_v2_COMMON_INCLUDES_
# define heli_q8_task4_p2_v2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_task4_p2_v2_COMMON_INCLUDES_ */

#include "heli_q8_task4_p2_v2_types.h"
...
#define heli_q8_task4_p2_v2_rtModel    RT_MODEL_heli_q8_task4_p2_v2_T
...
typedef struct {
  ...
  real_T Sum;                          /* '<Root>/Sum' */
  real_T Sum9[6];                      /* '<S6>/Sum9' */
  real_T K_ei;                         /* '<S8>/K_ei' */
} B_heli_q8_task4_p2_v2_T;
...
} DW_heli_q8_task4_p2_v2_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator2_CSTATE[6];        /* '<S6>/Integrator2' */
...
typedef struct {
  ...
  real_T TravelTransferFcn_CSTATE;     /* '<S3>/Travel: Transfer Fcn' */
  real_T Integrator_CSTATE;            /* '<S8>/Integrator' */
} XDot_heli_q8_task4_p2_v2_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator2_CSTATE[6];     /* '<S6>/Integrator2' */
...
#define rtB                            heli_q8_task4_p2_v2_B
#define BlockIO                        B_heli_q8_task4_p2_v2_T
#define rtX                            heli_q8_task4_p2_v2_X
#define ContinuousStates               X_heli_q8_task4_p2_v2_T
#define rtXdot                         heli_q8_task4_p2_v2_XDot
#define StateDerivatives               XDot_heli_q8_task4_p2_v2_T
#define tXdis                          heli_q8_task4_p2_v2_XDis
#define StateDisabled                  XDis_heli_q8_task4_p2_v2_T
#define rtP                            heli_q8_task4_p2_v2_P
#define Parameters                     P_heli_q8_task4_p2_v2_T
#define rtDWork                        heli_q8_task4_p2_v2_DW
#define D_Work                         DW_heli_q8_task4_p2_v2_T

/* Parameters (auto storage) */
struct P_heli_q8_task4_p2_v2_T_ {
...
struct tag_RTM_heli_q8_task4_p2_v2_T {
  const char_T *path;
...
extern P_heli_q8_task4_p2_v2_T heli_q8_task4_p2_v2_P;

/* Block signals (auto storage) */
extern B_heli_q8_task4_p2_v2_T heli_q8_task4_p2_v2_B;

/* Continuous states (auto storage) */
extern X_heli_q8_task4_p2_v2_T heli_q8_task4_p2_v2_X;

/* Block states (auto storage) */
extern DW_heli_q8_task4_p2_v2_T heli_q8_task4_p2_v2_DW;
...
extern void heli_q8_task4_p2_v2_initialize(void);
extern void heli_q8_task4_p2_v2_output0(void);
extern void heli_q8_task4_p2_v2_update0(void);
extern void heli_q8_task4_p2_v2_output(int_T tid);
extern void heli_q8_task4_p2_v2_update(int_T tid);
extern void heli_q8_task4_p2_v2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_task4_p2_v2_T *const heli_q8_task4_p2_v2_M;
 ...
 *
 * '<Root>' : 'heli_q8_task4_p2_v2'
 * '<S1>'   : 'heli_q8_task4_p2_v2/Conversion'
 * '<S2>'   : 'heli_q8_task4_p2_v2/Elevation controller'
 * '<S3>'   : 'heli_q8_task4_p2_v2/Heli 3D'
 * '<S4>'   : 'heli_q8_task4_p2_v2/Joystick'
 * '<S5>'   : 'heli_q8_task4_p2_v2/Pitch controller'
 * '<S6>'   : 'heli_q8_task4_p2_v2/Subsystem'
 * '<S7>'   : 'heli_q8_task4_p2_v2/Travel controller'
 * '<S8>'   : 'heli_q8_task4_p2_v2/Elevation controller/Elevation controller'
 * '<S9>'   : 'heli_q8_task4_p2_v2/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'heli_q8_task4_p2_v2/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'heli_q8_task4_p2_v2/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'heli_q8_task4_p2_v2/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'heli_q8_task4_p2_v2/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'heli_q8_task4_p2_v2/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_task4_p2_v2_h_ */
